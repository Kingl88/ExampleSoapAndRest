package ru.example.example_soap.configs;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition groupsWsdl11Definition(XsdSchema groupsSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.example.com/spring/ws/groups");
    ...
    public DefaultWsdl11Definition studentsWsdl11Definition(XsdSchema studentsSchema) {
        ...
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.example.com/spring/ws/students");
    ...
    public XsdSchema groupsSchema() {
        return new SimpleXsdSchema(new ClassPathResource("schemes_xsd/groups.xsd"));
    }

    @Bean
    public XsdSchema studentsSchema() {
        return new SimpleXsdSchema(new ClassPathResource("schemes_xsd/students.xsd"));
    }
}
